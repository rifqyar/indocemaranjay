  ...
  <nav class="navbar-fixed transparent z-depth-0" role="navigation" style="height: 80px; padding-top: 10px;">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        @else
          <li>
            <a class="waves-effect waves-light btn-small deep-orange modal-trigger"  href="{{ route('logout') }}"
    ...
    <div class="modal-content center">
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="input-field">
          ...
          <input type="text" id="email" name="email" class="validate @error('email') invalid @enderror">
        ...
        <div class="input-field">
          ...
          <input id="password" type="password" class="validate" name="password @error('password') invalid @enderror">
  ...
  <div id="daftar" class="modal ">
    ...
    <div class="modal-content center">
      ...
      <form method="POST" action="{{ route('register') }}">
        @csrf
        <div class="input-field">
          <input type="text" name="id_user" class="validate @error('no_telp') invalid @enderror" value="{{ $newIdUser ?? '' }}" hidden>
        ...
        <div class="input-field">
          ...
          <input id="email2" type="email" class="validate @error('email') invalid @enderror" name="email">
        ...
        <div class="input-field">
          <i class="material-icons prefix">lock</i>
          <input id="password2" type="password" class="validate @error('password') invalid @enderror" name="password">
        ...
        <div class="input-field">
          <i class="material-icons prefix">lock</i>
          <input id="password-confirm" type="password" class="validate @error('password_confirmation') invalid @enderror" name="password_confirmation">
    ...
    <script type="text/javascript">
      $( function(){
        swal({
          title: "Yeeay Akun Anda Berhasil di Daftarkan",
          text: "Akun anda telah didaftarkan, silahkan cek email anda untuk aktifasi akun",
          icon: "success",
          buttons: true,
        })
        .then((ok) => {
