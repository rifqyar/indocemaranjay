  ...
  <div class="row deep-orange accent-3" id="feature" style="margin-bottom: 0">
    <div class="container" style="padding-top: 150px;">
      ...
      <div class="col s12 m6" style="padding-bottom: 200px; margin-top: 20px">
        <img src="<?php echo e(asset('img/history1.png')); ?>" class="img-fluid">
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\indo-cemara\resources\views/home.blade.php ENDPATH**/ ?>