...
trait RedirectsUsers
{
    ...
    {
        return property_exists($this, 'redirectIfVerified') ? $this->redirectIfVerified : '/user';
    }
    ...
    {
        return property_exists($this, 'redirectAfterVerification') ? $this->redirectAfterVerification : '/user';
    }
